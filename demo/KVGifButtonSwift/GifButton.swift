...
class GifButton : UIButton {
  ...
  /**
   repeatCount - number of repeat Gif animation. Set in Interface Builder.
   */
  ...
  /**
   animationDuration - number of speed Gif animation. Set in Interface Builder.
   */
  ...
  /**
   gifName - name of Gif animation. Set in Interface Builder.
   */
  ...
  /**
   _imagesArray - an array of images which sets the user  if there is no whole GIF. NON private var
   */
  ...
  /**
   reversedImages - an array of reverse images on second tap button.
   */
  ...
  /**
   ...
   - Parameter imagesArray: Array of images for create Gif.
   */
  private func updateImagesArray(imagesArray: [UIImage]) {
  ...
  @objc private func starAnimationDidFinish() {
